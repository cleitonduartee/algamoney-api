...
public interface ILancamentoService extends ICrudService<Lancamento, LancamentoDTO>{

    Lancamento converterLancamentoRequestParaLancamentoEntity(LancamentoRequestDTO lancamentoRequest);
}
